...
/**
    * La clase PanelTabApp es una clase que hereda de la clase JPanel e implementa la interfaz ActionListener,
...
public class PanelTabApp extends JPanel implements ActionListener{
	...
	public PanelTabApp(JTabbedPane pane){
        ...
        JLabel label = new JLabel() {
            public String getText() {
                int i = pane.indexOfTabComponent(PanelTabApp.this);
                if (i != -1) {
        ...
        ButtonTabbedApp button = new ButtonTabbedApp(17);
		add(button);
