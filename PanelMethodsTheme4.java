...
public abstract class PanelMethodsTheme4 extends PanelMethodsAnalisisNumerico{

    protected final JLabel titulo_funcion = new JLabel("Función:");
    protected final TextFieldFuncion funcion= new TextFieldFuncion(" Función",Color.BLACK);
    protected final JLabel titulo_metodo = new JLabel("Método:");
    protected final TextFieldString metodo = new TextFieldString(" Método",Color.BLACK);

    protected PanelTextArea soluciones;

    public PanelMethodsTheme4(){}

    public PanelMethodsTheme4(Color fondo,String metodo){
        super(fondo);
