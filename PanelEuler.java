...
import modelo.theme5.MetodoEulerED;
...
/**
    ...
    * la interfaz ActionListener para ejecutar el método numérico de Euler para solucionar ecuación diferencial, se encarga de crear un panel específico para la visualización
    * del método numérico de Euler para solucionar ecuación diferencial.
    * @author German López Rodrigo
    * @version 13/05/2017/Final 
*/
public final class PanelEuler extends PanelMethodED implements ActionListener{
	/** * Variable tipo privada MetodoEulerED que representa el método de Euler para solucionar ecuación diferencial.*/
	private MetodoEulerED euler;

	/** * Método constructor que crear un PanelEuler pero sin ninguna comportamiento ni estilo especifico.*/
	public PanelEuler(){}

	/** * Método constructor que crea un PanelEuler, recibe el color del fondo para el panel.*/
	public PanelEuler(Color fondo){
		super(new Color(76, 123, 171),"Método de Euler ED");
		setPanelDatos();
		setInformacion();
		setAllElements();
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == calcular){
			if(!getEmptyFields() && getFieldsValids()){
				...
				euler = new MetodoEulerED((funcion.getText()).trim(),Integer.parseInt(n.getText().trim())
	...
	/** * Método privado setInformacion que se encarga de insertar el texto de información sobre el método de Euler para solucionar ecuación diferencial en el PanelEuler.*/
	private final void setInformacion(){
		str_formulas = "<font size = 4.5 face = Times New Roman>Y<sub>i+1</sub> = Y<sub>i</sub> + h*f(X<sub>i</sub>)";
		...
		+"los me&#769;todos nume&#769;ricos que ofrecen la solucio&#769;n de estas ecuaciones diferenciales. Los me&#769;todos paso a paso se "
		...
		+"<p>Es necesario hacer algunas precisiones en esta ecuacio&#769;n. Toda vez que se trata de integrar entre dos puntos consecutivos Xi y Xi+1, e&#769;stos "
